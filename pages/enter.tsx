      ...
      <div className='mt-8'>
        <div className='flex flex-col items-center'>
          ...
          <div className='grid border-b w-full mt-8 grid-cols-2 gap-16'>
            <button className={cls('pb-4 font-medium border-b-2', 
            method === 'email' 
          ...
          <div className='mt-1'>
            ...
            {method === 'phone' ? (
              <div className='flex rounded-md shadow-sm'>
                <span className='flex items-center justify-center px-3 rounded-l-md border border-r-0 bg-gray-50 text-gray-500 select-none text-sm'>+82</span>
                <input 
                className='appearance-none w-full px-3 py-2 border border-gray-300 rounded-md rounded-l-none shadow-sm placeholder-grey-400 focus:ring-orange-500 focus:border-orange-500 focus:outline-none'
                type='number' 
                required
                id='input'
                />
