...
const Home: NextPage = () => {
  return (
    ...
    //           <div key={result} className='flex justify-between my-2'>
    ...
    //         </div>
    //         <div className='h-24 w-24 bg-neutral-300 rounded-full group-hover:bg-red-500 transition-colors' />
    //         <div className='flex flex-col items-center'>
    ...
    //           <button className='rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8 text-gray-500'>-</button>
    //           <span>1</span>
    //           <button className='rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8 text-gray-500'>+</button>
    //         </div>
    //       </div>
